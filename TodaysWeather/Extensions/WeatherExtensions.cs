...
{
	/* History
	 * Version 1.0.0.3 (2020-03-30)
	 * - Added: string ToCalsiusUnit(this double)
	...
	public static class WeatherExtensions
	{
		...
		public static string ToCalsiusUnit(this double Kelvin)
		{
			return $"{(decimal)Math.Floor((Kelvin - 273.15) * 10) / 10} \u00b0C";
		}
		#endregion
